...
export const MenuMessNameOptions = {
	Polytechnic: 'Polytechnic',
	Management: 'Management'
} as const;
export type MenuMessNameOptions = (typeof MenuMessNameOptions)[keyof typeof MenuMessNameOptions];
